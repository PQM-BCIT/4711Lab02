				<div class="box">
					<div>
						<div class="body">
							...
							<ul id="rooms">
								<li>
									<a href="rooms.html"><img src="../assets/images/first-class.jpg" alt="Img"></a>
								...
								<li>
									<a href="rooms.html"><img src="../assets/images/deluxe.jpg" alt="Img"></a>
								...
								<li>
									<a href="rooms.html"><img src="../assets/images/suite.jpg" alt="Img"></a>
